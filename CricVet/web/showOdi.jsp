...
<html>
    ...
    <body>
        ...
        <tr>
                <td>First Ten Overs</td>
        <c:forEach var="temp" items="${batRecords_In1_1}">
            <td>${temp.getFirstTenOvers()}</td>
        </c:forEach>
             </tr>
         <tr>
        ...
        <c:forEach var="temp" items="${batRecords_In1_1}">
            <td>${temp.getFirstWicket()}</td>
             ...
             <tr>
                <td>Last Ten Overs</td>
        <c:forEach var="temp" items="${batRecords_In1_1}">
            <td>${temp.getLastTenOvers()}</td>
        </c:forEach>
             </tr>
             <tr>
                <td>Total Runs</td>
        ...
        <c:forEach var="temp" items="${bowlRecords_In1_2}">
            <td>${temp.getFirstOver()}</td>
               ...
               <table>
                <thead><h4>First Ten Overs Runs</h4></thead>
            <tr>
                <td>
            <table border="1px">
                <thead><h5>${teamName1} (Runs Scored)</h5></thead>
        ...
        <c:forEach var="temp" items="${bowlRecords_In1_2}">
            <td>${temp.getFirstWicket()}</td>
               ...
               <table>
                <thead><h4>Last Ten Overs Runs</h4></thead>
            <tr>
                <td>
            <table border="1px">
                <thead><h5>${teamName1} (Runs Scored)</h5></thead>
