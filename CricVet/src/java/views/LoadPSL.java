 ...
 * @author DELL
 */
public class LoadPSL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Load PSL</title>");
...
//            out.println("<h1>Servlet LoadIPL at " + request.getContextPath() + "</h1>");
            ...
            for (int y = year; y >= 2018; y--) {
                Document matches = Jsoup.connect("http://stats.espncricinfo.com/ci/engine/records/team/match_results.html?id=" + (y-1) +"%2F"+ (y%100) + ";trophy=205;type=season").get();
